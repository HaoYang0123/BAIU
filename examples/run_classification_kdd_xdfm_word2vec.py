...
from deepctr_torch.models.xdeepfm_word2vec import xDeepFM
from deepctr_torch.models.model_lm import NLPBertModel
...
if __name__ == "__main__":
    ...
    title_npy_folder = "/data/apple.yang/ctr/kdd_2012/word2vec/title"
    query_npy_folder = "/data/apple.yang/ctr/kdd_2012/word2vec/query"
    des_npy_folder = "/data/apple.yang/ctr/kdd_2012/word2vec/des"
    ...
    # with open(tokenid_hash_path, encoding='utf8') as f:
    #     tokenid2new_id = json.load(f)
    # titleid2id_list = _load_title(titleid_path, tokenid2new_id, tokenizer)
    # queryid2id_list = _load_title(queryid_path, tokenid2new_id, tokenizer)
    # desid2id_list = _load_title(desid_path, tokenid2new_id, tokenizer)
